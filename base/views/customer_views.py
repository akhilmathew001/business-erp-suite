...
def form_view(request,customer_id):
    try:
        ...
        context = {'customer':customer_form, 'customer_obj':customer}  
        ...
        try:
            ...
            try:
                if customer_state == 'none':
                    ...
                    state_obj = State.objects.get(pk=customer_state)
                if customer_country == 'none':
                    country_obj = None
                else:
                    country_obj = Country.objects.get(pk=customer_country)
                if customer_company == None:
                    company = None
                else:
                    company = Company.objects.get(pk=customer_company)
